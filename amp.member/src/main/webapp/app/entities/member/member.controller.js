(function() {
    ...
    MemberController.$inject = ['$scope', '$state', 'DataUtils', 'Member', 'ParseLinks', 'AlertService', 'pagingParams', 'paginationConstants'];

    function MemberController ($scope, $state, DataUtils, Member, ParseLinks, AlertService, pagingParams, paginationConstants) {
        var vm = this;
        vm.loadAll = loadAll;
        ...
        function loadAll (tableState) {
            ...
            Member.findByLike(searchInput, onSuccess, onError);
