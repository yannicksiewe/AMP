(function() {
    ...
    PartnerController.$inject = ['$scope', '$state', 'Partner', 'ParseLinks', 'AlertService', 'pagingParams', 'paginationConstants'];

    function PartnerController ($scope, $state, Partner, ParseLinks, AlertService, pagingParams, paginationConstants) {
        var vm = this;
        vm.loadAll = loadAll;
        ...
        function initSearch(){
            ...
            var searchInput={
                ...
                fieldNames: [],
                sortFieldNames: [],
                className: 'org.adorsys.amp.server.jpa.PartnerSearchInput'
            };
        ...
        function loadAll (tableState) {
            ...
            Partner.findByLike(searchInput, onSuccess, onError);
