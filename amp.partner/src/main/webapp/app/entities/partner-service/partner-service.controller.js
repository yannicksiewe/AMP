(function() {
    ...
    angular
        .module('ampmember')
        .controller('PartnerServiceController', PartnerServiceController);

    PartnerServiceController.$inject = ['$scope', '$state', 'PartnerService', 'ParseLinks', 'AlertService', 'pagingParams', 'paginationConstants'];

    function PartnerServiceController ($scope, $state, PartnerService, ParseLinks, AlertService, pagingParams, paginationConstants) {
        var vm = this;
        vm.loadAll = loadAll;
        ...
        function loadAll (tableState) {
            ...
            PartnerService.findByLike(searchInput, onSuccess, onError);
